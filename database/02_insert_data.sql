...
(101, 'Arjun', 'Kumar', TO_DATE('15-03-2002','DD-MM-YYYY'), 'Male', 'O+',
 '9876543210', 'arjun.kumar@gmail.com', 68.5,
...
(102, 'Priya', 'Sharma', TO_DATE('22-07-2001','DD-MM-YYYY'), 'Female', 'A+',
 '9876543211', 'priya.sharma@gmail.com', 55.0,
...
(103, 'Rahul', 'Verma', TO_DATE('08-11-2000','DD-MM-YYYY'), 'Male', 'B+',
 '9876543212', 'rahul.verma@gmail.com', 72.0,
...
(104, 'Sneha', 'Reddy', TO_DATE('19-05-2003','DD-MM-YYYY'), 'Female', 'O-',
 '9876543213', 'sneha.reddy@gmail.com', 58.5,
...
(105, 'Vikram', 'Singh', TO_DATE('11-01-1999','DD-MM-YYYY'), 'Male', 'AB+',
 '9876543214', 'vikram.singh@gmail.com', 80.0,
...
(106, 'Ananya', 'Iyer', TO_DATE('27-09-2002','DD-MM-YYYY'), 'Female', 'A-',
 '9876543215', 'ananya.iyer@gmail.com', 52.0,
...
(107, 'Karthik', 'Rao', TO_DATE('03-06-2001','DD-MM-YYYY'), 'Male', 'B-',
 '9876543216', 'karthik.rao@gmail.com', 70.5,
...
(108, 'Meera', 'Nair', TO_DATE('14-02-2000','DD-MM-YYYY'), 'Female', 'AB-',
 '9876543217', 'meera.nair@gmail.com', 60.0,
...
(109, 'Aditya', 'Menon', TO_DATE('29-08-1998','DD-MM-YYYY'), 'Male', 'O+',
 '9876543218', 'aditya.menon@gmail.com', 76.5,
...
(110, 'Divya', 'Krishnan', TO_DATE('17-12-2002','DD-MM-YYYY'), 'Female', 'B+',
 '9876543219', 'divya.krishnan@gmail.com', 57.5,
...
(111, 'Rohan', 'Patel', TO_DATE('05-04-2001','DD-MM-YYYY'), 'Male', 'A+',
 '9876543220', 'rohan.patel@gmail.com', 69.0,
...
(112, 'Lakshmi', 'Rajan', TO_DATE('21-10-1999','DD-MM-YYYY'), 'Female', 'O+',
 '9876543221', 'lakshmi.rajan@gmail.com', 61.0,
...
(113, 'Sanjay', 'Bose', TO_DATE('13-03-2000','DD-MM-YYYY'), 'Male', 'AB+',
 '9876543222', 'sanjay.bose@gmail.com', 74.0,
...
(114, 'Keerthi', 'Das', TO_DATE('09-06-2003','DD-MM-YYYY'), 'Female', 'O-',
 '9876543223', 'keerthi.das@gmail.com', 54.5,
...
(115, 'Naveen', 'Joseph', TO_DATE('30-01-1997','DD-MM-YYYY'), 'Male', 'A-',
 '9876543224', 'naveen.joseph@gmail.com', 82.0,
...
(116, 'Shreya', 'Gupta', TO_DATE('16-08-2002','DD-MM-YYYY'), 'Female', 'B+',
 '9876543225', 'shreya.gupta@gmail.com', 56.0,
...
(117, 'Harish', 'Srinivasan', TO_DATE('24-05-1998','DD-MM-YYYY'), 'Male', 'B-',
 '9876543226', 'harish.srinivasan@gmail.com', 78.5,
...
(118, 'Pooja', 'Krishnan', TO_DATE('07-11-2001','DD-MM-YYYY'), 'Female', 'AB-',
 '9876543227', 'pooja.krishnan@gmail.com', 59.0,
...
(119, 'Manoj', 'Shah', TO_DATE('18-02-1999','DD-MM-YYYY'), 'Male', 'O+',
 '9876543228', 'manoj.shah@gmail.com', 71.5,
...
(120, 'Aishwarya', 'Mohan', TO_DATE('26-09-2003','DD-MM-YYYY'), 'Female', 'A+',
 '9876543229', 'aishwarya.mohan@gmail.com', 53.0,
...
INSERT INTO DONOR_PHONE VALUES (101, '9123456780');
INSERT INTO DONOR_PHONE VALUES (101, '9001234501');
INSERT INTO DONOR_PHONE VALUES (102, '9123456781');
INSERT INTO DONOR_PHONE VALUES (103, '9123456782');
INSERT INTO DONOR_PHONE VALUES (105, '9123456784');
INSERT INTO DONOR_PHONE VALUES (105, '9001234505');
INSERT INTO DONOR_PHONE VALUES (109, '9123456788');
INSERT INTO DONOR_PHONE VALUES (112, '9123456791');
INSERT INTO DONOR_PHONE VALUES (115, '9123456794');
INSERT INTO DONOR_PHONE VALUES (120, '9123456799');
...
(201, 'Chennai Central Blood Bank', '044-28520001',
 'TNBB-1001', '10', 'Poonamallee High Road',
 'Egmore', 'Chennai', 'Tamil Nadu', '600008');

INSERT INTO BLOOD_BANK VALUES
(202, 'Apollo Blood Centre', '044-28290200',
 'TNBB-1002', '21', 'Greams Road',
 'Thousand Lights', 'Chennai', 'Tamil Nadu', '600006');

INSERT INTO BLOOD_BANK VALUES
(203, 'Government General Blood Bank', '044-25305000',
 'TNBB-1003', '5', 'EVR Periyar Road',
 'Park Town', 'Chennai', 'Tamil Nadu', '600003');

INSERT INTO BLOOD_BANK VALUES
(204, 'Lifeline Blood Centre', '044-22231000',
 'TNBB-1004', '42', 'Velachery Main Road',
 'Velachery', 'Chennai', 'Tamil Nadu', '600042');

INSERT INTO BLOOD_BANK VALUES
(205, 'Sri Ramachandra Blood Centre', '044-24768000',
 'TNBB-1005', '1', 'Porur Road',
...
(301, 'Apollo Hospitals', 'Dr. Suresh Kumar', '044-28293333');

INSERT INTO HOSPITAL VALUES
(302, 'Government General Hospital', 'Dr. Meena Ravi', '044-25305000');

INSERT INTO HOSPITAL VALUES
(303, 'MIOT International', 'Dr. Arvind Kumar', '044-42002288');

INSERT INTO HOSPITAL VALUES
(304, 'Fortis Malar Hospital', 'Dr. Priya Menon', '044-42892222');

INSERT INTO HOSPITAL VALUES
(305, 'Sri Ramachandra Medical Centre',
 'Dr. Karthik Raj', '044-24768000');
...
(401, 101, 201, TO_DATE('10-01-2026','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(402, 102, 202, TO_DATE('18-12-2025','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(403, 103, 203, TO_DATE('05-02-2026','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(404, 104, 204, TO_DATE('22-11-2025','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(405, 105, 205, TO_DATE('14-01-2026','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(406, 106, 201, TO_DATE('30-10-2025','DD-MM-YYYY'),
 0.00, 'Ineligible');

INSERT INTO DONATION VALUES
(407, 107, 202, TO_DATE('12-12-2025','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(408, 108, 203, TO_DATE('25-09-2025','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(409, 109, 204, TO_DATE('08-01-2026','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(410, 110, 205, TO_DATE('20-11-2025','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(411, 111, 201, TO_DATE('15-01-2026','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(412, 112, 202, TO_DATE('02-12-2025','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(413, 113, 203, TO_DATE('28-10-2025','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(414, 114, 204, TO_DATE('17-12-2025','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(415, 115, 205, TO_DATE('06-01-2026','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(416, 116, 201, TO_DATE('11-11-2025','DD-MM-YYYY'),
 0.00, 'Deferred');

INSERT INTO DONATION VALUES
(417, 117, 202, TO_DATE('19-12-2025','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(418, 118, 203, TO_DATE('27-09-2025','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(419, 119, 204, TO_DATE('09-01-2026','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(420, 120, 205, TO_DATE('03-12-2025','DD-MM-YYYY'),
 1.00, 'Eligible');

-- Repeat donors
INSERT INTO DONATION VALUES
(421, 101, 202, TO_DATE('10-09-2025','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(422, 103, 204, TO_DATE('05-10-2025','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(423, 105, 201, TO_DATE('14-09-2025','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(424, 111, 203, TO_DATE('15-09-2025','DD-MM-YYYY'),
 1.00, 'Eligible');

INSERT INTO DONATION VALUES
(425, 119, 205, TO_DATE('09-09-2025','DD-MM-YYYY'),
 1.00, 'Eligible');
...
-- 6. BLOOD_TEST_REPORT
-- 25 RECORDS
-- DonationID exactly matches the corresponding donation
-- =========================================================

INSERT INTO BLOOD_TEST_REPORT VALUES
(401, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 14.2, 'Negative', TO_DATE('10-01-2026','DD-MM-YYYY'), 'Passed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(402, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 13.6, 'Negative', TO_DATE('18-12-2025','DD-MM-YYYY'), 'Passed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(403, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 15.1, 'Negative', TO_DATE('05-02-2026','DD-MM-YYYY'), 'Passed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(404, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 12.8, 'Negative', TO_DATE('22-11-2025','DD-MM-YYYY'), 'Passed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(405, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 14.7, 'Negative', TO_DATE('14-01-2026','DD-MM-YYYY'), 'Passed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(406, 1, 'Not Tested', 'Not Tested', 'Not Tested', 'Not Tested',
 NULL, 'Not Tested', TO_DATE('30-10-2025','DD-MM-YYYY'), 'Failed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(407, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 15.0, 'Negative', TO_DATE('12-12-2025','DD-MM-YYYY'), 'Passed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(408, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 13.4, 'Negative', TO_DATE('25-09-2025','DD-MM-YYYY'), 'Passed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(409, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 14.9, 'Negative', TO_DATE('08-01-2026','DD-MM-YYYY'), 'Passed');

-- Failed infectious-disease screening
INSERT INTO BLOOD_TEST_REPORT VALUES
(410, 1, 'Positive', 'Negative', 'Negative', 'Negative',
 13.2, 'Negative', TO_DATE('20-11-2025','DD-MM-YYYY'), 'Failed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(411, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 14.4, 'Negative', TO_DATE('15-01-2026','DD-MM-YYYY'), 'Passed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(412, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 12.9, 'Negative', TO_DATE('02-12-2025','DD-MM-YYYY'), 'Passed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(413, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 15.3, 'Negative', TO_DATE('28-10-2025','DD-MM-YYYY'), 'Passed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(414, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 13.7, 'Negative', TO_DATE('17-12-2025','DD-MM-YYYY'), 'Passed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(415, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 14.1, 'Negative', TO_DATE('06-01-2026','DD-MM-YYYY'), 'Passed');

-- Deferred donation
INSERT INTO BLOOD_TEST_REPORT VALUES
(416, 1, 'Not Tested', 'Not Tested', 'Not Tested', 'Not Tested',
 NULL, 'Not Tested', TO_DATE('11-11-2025','DD-MM-YYYY'), 'Failed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(417, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 15.2, 'Negative', TO_DATE('19-12-2025','DD-MM-YYYY'), 'Passed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(418, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 13.5, 'Negative', TO_DATE('27-09-2025','DD-MM-YYYY'), 'Passed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(419, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 14.6, 'Negative', TO_DATE('09-01-2026','DD-MM-YYYY'), 'Passed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(420, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 13.8, 'Negative', TO_DATE('03-12-2025','DD-MM-YYYY'), 'Passed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(421, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 14.0, 'Negative', TO_DATE('10-09-2025','DD-MM-YYYY'), 'Passed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(422, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 15.0, 'Negative', TO_DATE('05-10-2025','DD-MM-YYYY'), 'Passed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(423, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 14.5, 'Negative', TO_DATE('14-09-2025','DD-MM-YYYY'), 'Passed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(424, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 13.9, 'Negative', TO_DATE('15-09-2025','DD-MM-YYYY'), 'Passed');

INSERT INTO BLOOD_TEST_REPORT VALUES
(425, 1, 'Negative', 'Negative', 'Negative', 'Negative',
 14.3, 'Negative', TO_DATE('09-09-2025','DD-MM-YYYY'), 'Passed');
...
-- Request 503: 1 unit B+
INSERT INTO BLOOD_ALLOCATION VALUES
(705, 503, 603,
 TO_DATE('20-02-2026','DD-MM-YYYY'), 1.00);


-- Request 504: 2 units O-
INSERT INTO BLOOD_ALLOCATION VALUES
(706, 504, 604,
...
-- Request 506: 1 unit A-
INSERT INTO BLOOD_ALLOCATION VALUES
(710, 506, 615,
 TO_DATE('16-02-2026','DD-MM-YYYY'), 1.00);


-- Request 507: 1 unit B-
INSERT INTO BLOOD_ALLOCATION VALUES
(711, 507, 607,
...
SELECT 'DONOR_PHONE', COUNT(*)
FROM DONOR_PHONE

UNION ALL

SELECT 'BLOOD_BANK', COUNT(*)
FROM BLOOD_BANK
...
SELECT 'BLOOD_TEST_REPORT', COUNT(*)
FROM BLOOD_TEST_REPORT

UNION ALL

SELECT 'BLOOD_INVENTORY', COUNT(*)
FROM BLOOD_INVENTORY

UNION ALL

SELECT 'BLOOD_REQUEST', COUNT(*)
FROM BLOOD_REQUEST

UNION ALL

SELECT 'BLOOD_ALLOCATION', COUNT(*)
